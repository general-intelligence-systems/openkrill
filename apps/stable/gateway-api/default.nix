...
in
{
  ...
  config = mkIf cfg.enable {
    openkrill.apps.argo-cd.applications.gateway-api = mkIf config.openkrill.gitops.generateApplications {
      namespace = "argo-cd";
      project = "default";
      source = {
    ...
    openkrill.manifests."gateway-api".content = mkIf cfg.safeUpgrades [
      {
