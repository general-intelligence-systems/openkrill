...
let
  ...
  ClusterissuersModule = types.submodule (
    { name, ... }:
    {
      options = {
        "namespace" = mkOption {
          type = types.str;
          description = "Namespace for this ClusterIssuer resource.";
        };
        "acme" = mkOption {
  ...
  allResources = (mapAttrsToList mkClusterIssuer cfg."clusterissuers");
in
{
  options.openkrill.apps."cert-manager" = {
    "clusterissuers" = mkOption {
      type = types.attrsOf ClusterissuersModule;
      default = { };
      description = "ClusterIssuer CRD instances.";
    };
  };
