...
let
  ...
  CiliumclusterwidenetworkpoliciesModule = types.submodule (
    { name, ... }:
    {
      options = {
        "namespace" = mkOption {
          type = types.str;
          description = "Namespace for this CiliumClusterwideNetworkPolicy resource.";
        };
  ...
  mkCiliumClusterwideNetworkPolicy = name: res: {
  ...
  allResources = (
    mapAttrsToList mkCiliumClusterwideNetworkPolicy cfg."ciliumclusterwidenetworkpolicies"
  );
in
{
  options.openkrill.apps."cilium" = {
    "ciliumclusterwidenetworkpolicies" = mkOption {
      type = types.attrsOf CiliumclusterwidenetworkpoliciesModule;
      default = { };
      description = "CiliumClusterwideNetworkPolicy CRD instances.";
    };
  };
