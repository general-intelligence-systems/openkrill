...
let
  ...
  EndpointMetricRelabelingModule = types.submodule {
    options = {
      "action" = mkOption {
  ...
  EndpointModule = types.submodule {
    options = {
      ...
      "metricRelabelings" = mkOption {
        ...
        type = (types.listOf EndpointMetricRelabelingModule);
        default = [ ];
      };
      "noProxy" = mkOption {
      ...
      "relabelings" = mkOption {
        ...
        type = (types.listOf EndpointRelabelingModule);
        default = [ ];
      };
      "scheme" = mkOption {
  ...
  mkEndpoint =
    ...
    // optionalAttrs (res."metricRelabelings" != [ ]) {
      "metricRelabelings" = map mkEndpointMetricRelabeling res."metricRelabelings";
    }
    // {
    }
    ...
    // optionalAttrs (res."relabelings" != [ ]) {
      "relabelings" = map mkEndpointRelabeling res."relabelings";
    }
    // {
    }
  ...
  EndpointOauth2ClientIdConfigMapModule = types.submodule {
    options = {
      "key" = mkOption {
  ...
  mkEndpointOauth2ClientIdConfigMap =
    res:
    {
      inherit (res) "key";
    }
  ...
  EndpointOauth2ClientIdModule = types.submodule {
    options = {
      "configMap" = mkOption {
        description = "ConfigMap containing data to use for the targets.";
        type = (types.nullOr EndpointOauth2ClientIdConfigMapModule);
        default = null;
      };
      "secret" = mkOption {
        description = "Secret containing data to use for the targets.";
        type = (types.nullOr EndpointOauth2ClientIdSecretModule);
        default = null;
      };
    };
  };
  mkEndpointOauth2ClientId =
    res:
    {
    }
    // optionalAttrs (res."configMap" != null) {
      "configMap" = mkEndpointOauth2ClientIdConfigMap res."configMap";
    }
    // {
    }
    // optionalAttrs (res."secret" != null) { "secret" = mkEndpointOauth2ClientIdSecret res."secret"; }
    // {
    };
  EndpointOauth2ClientIdSecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkEndpointOauth2ClientIdSecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  EndpointOauth2ClientSecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  EndpointOauth2Module = types.submodule {
    options = {
      ...
      "tlsConfig" = mkOption {
        ...
        type = (types.nullOr EndpointOauth2TlsConfigModule);
        default = null;
      };
      "tokenUrl" = mkOption {
  ...
  mkEndpointOauth2 =
    res:
    {
      "clientId" = mkEndpointOauth2ClientId res."clientId";
      "clientSecret" = mkEndpointOauth2ClientSecret res."clientSecret";
    }
    ...
    // optionalAttrs (res."tlsConfig" != null) {
      "tlsConfig" = mkEndpointOauth2TlsConfig res."tlsConfig";
    }
    // {
      inherit (res) "tokenUrl";
    };
  EndpointOauth2TlsConfigCaConfigMapModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key to select.";
        type = types.str;
  ...
  mkEndpointOauth2TlsConfigCaConfigMap =
    res:
    {
      inherit (res) "key";
    }
  ...
  EndpointOauth2TlsConfigCaModule = types.submodule {
    options = {
      "configMap" = mkOption {
        description = "ConfigMap containing data to use for the targets.";
        type = (types.nullOr EndpointOauth2TlsConfigCaConfigMapModule);
        default = null;
      };
      "secret" = mkOption {
        description = "Secret containing data to use for the targets.";
        type = (types.nullOr EndpointOauth2TlsConfigCaSecretModule);
        default = null;
      };
    };
  };
  mkEndpointOauth2TlsConfigCa =
    res:
    {
    }
    // optionalAttrs (res."configMap" != null) {
      "configMap" = mkEndpointOauth2TlsConfigCaConfigMap res."configMap";
    }
    // {
    }
    // optionalAttrs (res."secret" != null) {
      "secret" = mkEndpointOauth2TlsConfigCaSecret res."secret";
    }
    // {
    };
  EndpointOauth2TlsConfigCaSecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkEndpointOauth2TlsConfigCaSecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  EndpointOauth2TlsConfigCertConfigMapModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key to select.";
        type = types.str;
  ...
  mkEndpointOauth2TlsConfigCertConfigMap =
    res:
    {
      inherit (res) "key";
    }
  ...
  EndpointOauth2TlsConfigCertModule = types.submodule {
    options = {
      "configMap" = mkOption {
        description = "ConfigMap containing data to use for the targets.";
        type = (types.nullOr EndpointOauth2TlsConfigCertConfigMapModule);
        default = null;
      };
      "secret" = mkOption {
        description = "Secret containing data to use for the targets.";
        type = (types.nullOr EndpointOauth2TlsConfigCertSecretModule);
        default = null;
      };
    };
  };
  mkEndpointOauth2TlsConfigCert =
    res:
    {
    }
    // optionalAttrs (res."configMap" != null) {
      "configMap" = mkEndpointOauth2TlsConfigCertConfigMap res."configMap";
    }
    // {
    }
    // optionalAttrs (res."secret" != null) {
      "secret" = mkEndpointOauth2TlsConfigCertSecret res."secret";
    }
    // {
    };
  EndpointOauth2TlsConfigCertSecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkEndpointOauth2TlsConfigCertSecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  EndpointOauth2TlsConfigKeySecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkEndpointOauth2TlsConfigKeySecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  EndpointOauth2TlsConfigModule = types.submodule {
    options = {
      "ca" = mkOption {
        description = "Certificate authority used when verifying server certificates.";
        type = (types.nullOr EndpointOauth2TlsConfigCaModule);
        default = null;
      };
      "cert" = mkOption {
        description = "Client certificate to present when doing client-authentication.";
        type = (types.nullOr EndpointOauth2TlsConfigCertModule);
        default = null;
      };
      ...
      "keySecret" = mkOption {
        ...
        type = (types.nullOr EndpointOauth2TlsConfigKeySecretModule);
        default = null;
      };
      "maxVersion" = mkOption {
  ...
  mkEndpointOauth2TlsConfig =
    res:
    {
    }
    // optionalAttrs (res."ca" != null) { "ca" = mkEndpointOauth2TlsConfigCa res."ca"; }
    // {
    }
    // optionalAttrs (res."cert" != null) { "cert" = mkEndpointOauth2TlsConfigCert res."cert"; }
    // {
    }
    ...
    // optionalAttrs (res."keySecret" != null) {
      "keySecret" = mkEndpointOauth2TlsConfigKeySecret res."keySecret";
    }
    // {
    }
  ...
  EndpointRelabelingModule = types.submodule {
    options = {
      "action" = mkOption {
        description = "Action to perform based on the regex matching.\n\n`Uppercase` and `Lowercase` actions require Prometheus >= v2.36.0.\n`DropEqual` and `KeepEqual` actions require Prometheus >= v2.41.0.\n\nDefault: \"Replace\"";
        type = (
  ...
  ServicemonitorsModule = types.submodule (
    { name, ... }:
    {
      options = {
        "namespace" = mkOption {
          type = types.str;
          description = "Namespace for this ServiceMonitor resource.";
        };
  ...
  allResources = (mapAttrsToList mkServiceMonitor cfg."servicemonitors");
in
{
  options.openkrill.apps."kube-prometheus" = {
    "servicemonitors" = mkOption {
      type = types.attrsOf ServicemonitorsModule;
      default = { };
      description = "ServiceMonitor CRD instances.";
    };
  };
