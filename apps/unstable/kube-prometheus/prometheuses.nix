...
let
  ...
  AdditionalAlertManagerConfigsModule = types.submodule {
    options = {
      "key" = mkOption {
  ...
  mkAdditionalAlertManagerConfigs =
    res:
    {
      inherit (res) "key";
    }
  ...
  AdditionalAlertRelabelConfigsModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkAdditionalAlertRelabelConfigs =
    res:
    {
      inherit (res) "key";
    }
  ...
  AlertingAlertmanagerAlertRelabelingModule = types.submodule {
    options = {
      "action" = mkOption {
  ...
  mkAlertingAlertmanagerAlertRelabeling =
    res:
    {
    }
  ...
  AlertingAlertmanagerAuthorizationCredentialsModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkAlertingAlertmanagerAuthorizationCredentials =
    res:
    {
      inherit (res) "key";
    }
  ...
  AlertingAlertmanagerAuthorizationModule = types.submodule {
    options = {
      "credentials" = mkOption {
        description = "Selects a key of a Secret in the namespace that contains the credentials for authentication.";
        type = (types.nullOr AlertingAlertmanagerAuthorizationCredentialsModule);
        default = null;
      };
      "type" = mkOption {
  ...
  mkAlertingAlertmanagerAuthorization =
    res:
    {
    }
    // optionalAttrs (res."credentials" != null) {
      "credentials" = mkAlertingAlertmanagerAuthorizationCredentials res."credentials";
    }
    // {
    }
  ...
  AlertingAlertmanagerBasicAuthModule = types.submodule {
    options = {
      "password" = mkOption {
        description = "`password` specifies a key of a Secret containing the password for\nauthentication.";
        type = (types.nullOr AlertingAlertmanagerBasicAuthPasswordModule);
        default = null;
      };
      "username" = mkOption {
        description = "`username` specifies a key of a Secret containing the username for\nauthentication.";
        type = (types.nullOr AlertingAlertmanagerBasicAuthUsernameModule);
        default = null;
      };
    };
  };
  mkAlertingAlertmanagerBasicAuth =
    res:
    {
    }
    // optionalAttrs (res."password" != null) {
      "password" = mkAlertingAlertmanagerBasicAuthPassword res."password";
    }
    // {
    }
    // optionalAttrs (res."username" != null) {
      "username" = mkAlertingAlertmanagerBasicAuthUsername res."username";
    }
    // {
    };
  AlertingAlertmanagerBasicAuthPasswordModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkAlertingAlertmanagerBasicAuthPassword =
    res:
    {
      inherit (res) "key";
    }
  ...
  AlertingAlertmanagerBasicAuthUsernameModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkAlertingAlertmanagerBasicAuthUsername =
    res:
    {
      inherit (res) "key";
    }
  ...
  AlertingAlertmanagerModule = types.submodule {
    options = {
      "alertRelabelings" = mkOption {
        ...
        type = (types.listOf AlertingAlertmanagerAlertRelabelingModule);
        default = [ ];
      };
      "apiVersion" = mkOption {
      ...
      "authorization" = mkOption {
        ...
        type = (types.nullOr AlertingAlertmanagerAuthorizationModule);
        default = null;
      };
      "basicAuth" = mkOption {
        ...
        type = (types.nullOr AlertingAlertmanagerBasicAuthModule);
        default = null;
      };
      ...
      "relabelings" = mkOption {
        ...
        type = (types.listOf AlertingAlertmanagerRelabelingModule);
        default = [ ];
      };
      "scheme" = mkOption {
      ...
      "sigv4" = mkOption {
        ...
        type = (types.nullOr AlertingAlertmanagerSigv4Module);
        default = null;
      };
      "timeout" = mkOption {
      ...
      "tlsConfig" = mkOption {
        ...
        type = (types.nullOr AlertingAlertmanagerTlsConfigModule);
        default = null;
      };
    };
  };
  mkAlertingAlertmanager =
    res:
    {
    }
    // optionalAttrs (res."alertRelabelings" != [ ]) {
      "alertRelabelings" = map mkAlertingAlertmanagerAlertRelabeling res."alertRelabelings";
    }
    // {
    }
    ...
    // optionalAttrs (res."authorization" != null) {
      "authorization" = mkAlertingAlertmanagerAuthorization res."authorization";
    }
    // {
    }
    // optionalAttrs (res."basicAuth" != null) {
      "basicAuth" = mkAlertingAlertmanagerBasicAuth res."basicAuth";
    }
    // {
    }
    ...
    // optionalAttrs (res."relabelings" != [ ]) {
      "relabelings" = map mkAlertingAlertmanagerRelabeling res."relabelings";
    }
    // {
    }
    ...
    // optionalAttrs (res."sigv4" != null) { "sigv4" = mkAlertingAlertmanagerSigv4 res."sigv4"; }
    // {
    }
    ...
    // optionalAttrs (res."tlsConfig" != null) {
      "tlsConfig" = mkAlertingAlertmanagerTlsConfig res."tlsConfig";
    }
    // {
    };
  AlertingAlertmanagerRelabelingModule = types.submodule {
    options = {
      "action" = mkOption {
        description = "Action to perform based on the regex matching.\n\n`Uppercase` and `Lowercase` actions require Prometheus >= v2.36.0.\n`DropEqual` and `KeepEqual` actions require Prometheus >= v2.41.0.\n\nDefault: \"Replace\"";
        type = (
  ...
  mkAlertingAlertmanagerRelabeling =
    res:
    {
    }
    // optionalAttrs (res."action" != null) { inherit (res) "action"; }
  ...
  AlertingAlertmanagerSigv4AccessKeyModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkAlertingAlertmanagerSigv4AccessKey =
    res:
    {
      inherit (res) "key";
    }
  ...
  AlertingAlertmanagerSigv4Module = types.submodule {
    options = {
      "accessKey" = mkOption {
        description = "AccessKey is the AWS API key. If not specified, the environment variable\n`AWS_ACCESS_KEY_ID` is used.";
        type = (types.nullOr AlertingAlertmanagerSigv4AccessKeyModule);
        default = null;
      };
      "profile" = mkOption {
      ...
      "secretKey" = mkOption {
        ...
        type = (types.nullOr AlertingAlertmanagerSigv4SecretKeyModule);
        default = null;
      };
    };
  };
  mkAlertingAlertmanagerSigv4 =
    res:
    {
    }
    // optionalAttrs (res."accessKey" != null) {
      "accessKey" = mkAlertingAlertmanagerSigv4AccessKey res."accessKey";
    }
    // {
    }
    ...
    // optionalAttrs (res."secretKey" != null) {
      "secretKey" = mkAlertingAlertmanagerSigv4SecretKey res."secretKey";
    }
    // {
    };
  AlertingAlertmanagerSigv4SecretKeyModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkAlertingAlertmanagerSigv4SecretKey =
    res:
    {
      inherit (res) "key";
    }
  ...
  AlertingAlertmanagerTlsConfigCaConfigMapModule = types.submodule {
    options = {
      "key" = mkOption {
  ...
  mkAlertingAlertmanagerTlsConfigCaConfigMap =
    res:
    {
      inherit (res) "key";
    }
  ...
  AlertingAlertmanagerTlsConfigCaModule = types.submodule {
    options = {
      "configMap" = mkOption {
        description = "ConfigMap containing data to use for the targets.";
        type = (types.nullOr AlertingAlertmanagerTlsConfigCaConfigMapModule);
        default = null;
      };
      "secret" = mkOption {
        description = "Secret containing data to use for the targets.";
        type = (types.nullOr AlertingAlertmanagerTlsConfigCaSecretModule);
        default = null;
      };
    };
  };
  mkAlertingAlertmanagerTlsConfigCa =
    res:
    {
    }
    // optionalAttrs (res."configMap" != null) {
      "configMap" = mkAlertingAlertmanagerTlsConfigCaConfigMap res."configMap";
    }
    // {
    }
    // optionalAttrs (res."secret" != null) {
      "secret" = mkAlertingAlertmanagerTlsConfigCaSecret res."secret";
    }
    // {
    };
  AlertingAlertmanagerTlsConfigCaSecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkAlertingAlertmanagerTlsConfigCaSecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  AlertingAlertmanagerTlsConfigCertConfigMapModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key to select.";
        type = types.str;
  ...
  mkAlertingAlertmanagerTlsConfigCertConfigMap =
    res:
    {
      inherit (res) "key";
    }
  ...
  AlertingAlertmanagerTlsConfigCertModule = types.submodule {
    options = {
      "configMap" = mkOption {
        description = "ConfigMap containing data to use for the targets.";
        type = (types.nullOr AlertingAlertmanagerTlsConfigCertConfigMapModule);
        default = null;
      };
      "secret" = mkOption {
        description = "Secret containing data to use for the targets.";
        type = (types.nullOr AlertingAlertmanagerTlsConfigCertSecretModule);
        default = null;
      };
    };
  };
  mkAlertingAlertmanagerTlsConfigCert =
    res:
    {
    }
    // optionalAttrs (res."configMap" != null) {
      "configMap" = mkAlertingAlertmanagerTlsConfigCertConfigMap res."configMap";
    }
    // {
    }
    // optionalAttrs (res."secret" != null) {
      "secret" = mkAlertingAlertmanagerTlsConfigCertSecret res."secret";
    }
    // {
    };
  AlertingAlertmanagerTlsConfigCertSecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkAlertingAlertmanagerTlsConfigCertSecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  AlertingAlertmanagerTlsConfigKeySecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkAlertingAlertmanagerTlsConfigKeySecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  AlertingAlertmanagerTlsConfigModule = types.submodule {
    options = {
      "ca" = mkOption {
        description = "Certificate authority used when verifying server certificates.";
        type = (types.nullOr AlertingAlertmanagerTlsConfigCaModule);
        default = null;
      };
      "caFile" = mkOption {
      ...
      "cert" = mkOption {
        ...
        type = (types.nullOr AlertingAlertmanagerTlsConfigCertModule);
        default = null;
      };
      "certFile" = mkOption {
      ...
      "keySecret" = mkOption {
        ...
        type = (types.nullOr AlertingAlertmanagerTlsConfigKeySecretModule);
        default = null;
      };
      "maxVersion" = mkOption {
  ...
  mkAlertingAlertmanagerTlsConfig =
    res:
    {
    }
    // optionalAttrs (res."ca" != null) { "ca" = mkAlertingAlertmanagerTlsConfigCa res."ca"; }
    // {
    }
    // optionalAttrs (res."caFile" != null) { inherit (res) "caFile"; }
    // {
    }
    // optionalAttrs (res."cert" != null) { "cert" = mkAlertingAlertmanagerTlsConfigCert res."cert"; }
    // {
    }
    ...
    // optionalAttrs (res."keySecret" != null) {
      "keySecret" = mkAlertingAlertmanagerTlsConfigKeySecret res."keySecret";
    }
    // {
    }
  ...
  AlertingModule = types.submodule {
    options = {
      "alertmanagers" = mkOption {
        description = "Alertmanager endpoints where Prometheus should send alerts to.";
        type = (types.listOf AlertingAlertmanagerModule);
      };
    };
  };
  mkAlerting = res: {
    "alertmanagers" = map mkAlertingAlertmanager res."alertmanagers";
  };
  ...
  ExemplarsModule = types.submodule {
    options = {
      "maxSize" = mkOption {
  ...
  PrometheusRulesExcludedFromEnforceModule = types.submodule {
    options = {
      "ruleName" = mkOption {
  ...
  mkPrometheusRulesExcludedFromEnforce = res: {
    inherit (res) "ruleName";
    inherit (res) "ruleNamespace";
  };
  QueryModule = types.submodule {
    options = {
  ...
  mkQuery =
    ...
    // optionalAttrs (res."lookbackDelta" != null) { inherit (res) "lookbackDelta"; }
    // {
    }
    // optionalAttrs (res."maxConcurrency" != null) { inherit (res) "maxConcurrency"; }
    // {
    }
    // optionalAttrs (res."maxSamples" != null) { inherit (res) "maxSamples"; }
    // {
    }
    // optionalAttrs (res."timeout" != null) { inherit (res) "timeout"; }
    // {
    };
  RemoteReadAuthorizationCredentialsModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkRemoteReadAuthorizationCredentials =
    res:
    {
      inherit (res) "key";
    }
  ...
  RemoteReadAuthorizationModule = types.submodule {
    options = {
      "credentials" = mkOption {
        description = "Selects a key of a Secret in the namespace that contains the credentials for authentication.";
        type = (types.nullOr RemoteReadAuthorizationCredentialsModule);
        default = null;
      };
      "credentialsFile" = mkOption {
        description = "File to read a secret from, mutually exclusive with `credentials`.";
  ...
  mkRemoteReadAuthorization =
    res:
    {
    }
    // optionalAttrs (res."credentials" != null) {
      "credentials" = mkRemoteReadAuthorizationCredentials res."credentials";
    }
    // {
    }
    // optionalAttrs (res."credentialsFile" != null) { inherit (res) "credentialsFile"; }
  ...
  RemoteReadBasicAuthModule = types.submodule {
    options = {
      "password" = mkOption {
        description = "`password` specifies a key of a Secret containing the password for\nauthentication.";
        type = (types.nullOr RemoteReadBasicAuthPasswordModule);
        default = null;
      };
      "username" = mkOption {
        description = "`username` specifies a key of a Secret containing the username for\nauthentication.";
        type = (types.nullOr RemoteReadBasicAuthUsernameModule);
        default = null;
      };
    };
  };
  mkRemoteReadBasicAuth =
    res:
    {
    }
    // optionalAttrs (res."password" != null) {
      "password" = mkRemoteReadBasicAuthPassword res."password";
    }
    // {
    }
    // optionalAttrs (res."username" != null) {
      "username" = mkRemoteReadBasicAuthUsername res."username";
    }
    // {
    };
  RemoteReadBasicAuthPasswordModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  RemoteReadBasicAuthUsernameModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  RemoteReadModule = types.submodule {
    options = {
      "authorization" = mkOption {
        description = "Authorization section for the URL.\n\nIt requires Prometheus >= v2.26.0.\n\nCannot be set at the same time as `basicAuth`, or `oauth2`.";
        type = (types.nullOr RemoteReadAuthorizationModule);
        default = null;
      };
      "basicAuth" = mkOption {
        description = "BasicAuth configuration for the URL.\n\nCannot be set at the same time as `authorization`, or `oauth2`.";
        type = (types.nullOr RemoteReadBasicAuthModule);
        default = null;
      };
      "bearerToken" = mkOption {
        description = "*Warning: this field shouldn't be used because the token value appears\nin clear-text. Prefer using `authorization`.*\n\nDeprecated: this will be removed in a future release.";
      ...
      "oauth2" = mkOption {
        ...
        type = (types.nullOr RemoteReadOauth2Module);
        default = null;
      };
      "proxyConnectHeader" = mkOption {
        description = "ProxyConnectHeader optionally specifies headers to send to\nproxies during CONNECT requests.\n\nIt requires Prometheus >= v2.43.0, Alertmanager >= v0.25.0 or Thanos >= v0.32.0.";
      ...
      "tlsConfig" = mkOption {
        ...
        type = (types.nullOr RemoteReadTlsConfigModule);
        default = null;
      };
      "url" = mkOption {
  ...
  mkRemoteRead =
    ...
    // optionalAttrs (res."authorization" != null) {
      "authorization" = mkRemoteReadAuthorization res."authorization";
    }
    // {
    }
    // optionalAttrs (res."basicAuth" != null) { "basicAuth" = mkRemoteReadBasicAuth res."basicAuth"; }
    // {
    }
    // optionalAttrs (res."bearerToken" != null) { inherit (res) "bearerToken"; }
    // {
    ...
    // optionalAttrs res."filterExternalLabels" { inherit (res) "filterExternalLabels"; }
    // {
    }
    ...
    // optionalAttrs (res."oauth2" != null) { "oauth2" = mkRemoteReadOauth2 res."oauth2"; }
    // {
    }
    // optionalAttrs (res."proxyConnectHeader" != { }) { inherit (res) "proxyConnectHeader"; }
    // {
    ...
    // optionalAttrs res."readRecent" { inherit (res) "readRecent"; }
    // {
    }
    // optionalAttrs (res."remoteTimeout" != null) { inherit (res) "remoteTimeout"; }
    // {
    }
    // optionalAttrs (res."requiredMatchers" != { }) { inherit (res) "requiredMatchers"; }
    // {
    }
    // optionalAttrs (res."tlsConfig" != null) { "tlsConfig" = mkRemoteReadTlsConfig res."tlsConfig"; }
    // {
      inherit (res) "url";
    };
  RemoteReadOauth2ClientIdConfigMapModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key to select.";
        type = types.str;
  ...
  mkRemoteReadOauth2ClientIdConfigMap =
    res:
    {
      inherit (res) "key";
    }
  ...
  RemoteReadOauth2ClientIdModule = types.submodule {
    options = {
      "configMap" = mkOption {
        description = "ConfigMap containing data to use for the targets.";
        type = (types.nullOr RemoteReadOauth2ClientIdConfigMapModule);
        default = null;
      };
      "secret" = mkOption {
        description = "Secret containing data to use for the targets.";
        type = (types.nullOr RemoteReadOauth2ClientIdSecretModule);
        default = null;
      };
    };
  };
  mkRemoteReadOauth2ClientId =
    res:
    {
    }
    // optionalAttrs (res."configMap" != null) {
      "configMap" = mkRemoteReadOauth2ClientIdConfigMap res."configMap";
    }
    // {
    }
    // optionalAttrs (res."secret" != null) {
      "secret" = mkRemoteReadOauth2ClientIdSecret res."secret";
    }
    // {
    };
  RemoteReadOauth2ClientIdSecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkRemoteReadOauth2ClientIdSecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  RemoteReadOauth2ClientSecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkRemoteReadOauth2ClientSecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  RemoteReadOauth2Module = types.submodule {
    options = {
      ...
      "tlsConfig" = mkOption {
        ...
        type = (types.nullOr RemoteReadOauth2TlsConfigModule);
        default = null;
      };
      "tokenUrl" = mkOption {
  ...
  mkRemoteReadOauth2 =
    res:
    {
      "clientId" = mkRemoteReadOauth2ClientId res."clientId";
      "clientSecret" = mkRemoteReadOauth2ClientSecret res."clientSecret";
    }
    ...
    // optionalAttrs (res."tlsConfig" != null) {
      "tlsConfig" = mkRemoteReadOauth2TlsConfig res."tlsConfig";
    }
    // {
      inherit (res) "tokenUrl";
    };
  RemoteReadOauth2TlsConfigCaConfigMapModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key to select.";
        type = types.str;
  ...
  mkRemoteReadOauth2TlsConfigCaConfigMap =
    res:
    {
      inherit (res) "key";
    }
  ...
  RemoteReadOauth2TlsConfigCaModule = types.submodule {
    options = {
      "configMap" = mkOption {
        description = "ConfigMap containing data to use for the targets.";
        type = (types.nullOr RemoteReadOauth2TlsConfigCaConfigMapModule);
        default = null;
      };
      "secret" = mkOption {
        description = "Secret containing data to use for the targets.";
        type = (types.nullOr RemoteReadOauth2TlsConfigCaSecretModule);
        default = null;
      };
    };
  };
  mkRemoteReadOauth2TlsConfigCa =
    res:
    {
    }
    // optionalAttrs (res."configMap" != null) {
      "configMap" = mkRemoteReadOauth2TlsConfigCaConfigMap res."configMap";
    }
    // {
    }
    // optionalAttrs (res."secret" != null) {
      "secret" = mkRemoteReadOauth2TlsConfigCaSecret res."secret";
    }
    // {
    };
  RemoteReadOauth2TlsConfigCaSecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkRemoteReadOauth2TlsConfigCaSecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  RemoteReadOauth2TlsConfigCertConfigMapModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key to select.";
        type = types.str;
  ...
  mkRemoteReadOauth2TlsConfigCertConfigMap =
    res:
    {
      inherit (res) "key";
    }
  ...
  RemoteReadOauth2TlsConfigCertModule = types.submodule {
    options = {
      "configMap" = mkOption {
        description = "ConfigMap containing data to use for the targets.";
        type = (types.nullOr RemoteReadOauth2TlsConfigCertConfigMapModule);
        default = null;
      };
      "secret" = mkOption {
        description = "Secret containing data to use for the targets.";
        type = (types.nullOr RemoteReadOauth2TlsConfigCertSecretModule);
        default = null;
      };
    };
  };
  mkRemoteReadOauth2TlsConfigCert =
    res:
    {
    }
    // optionalAttrs (res."configMap" != null) {
      "configMap" = mkRemoteReadOauth2TlsConfigCertConfigMap res."configMap";
    }
    // {
    }
    // optionalAttrs (res."secret" != null) {
      "secret" = mkRemoteReadOauth2TlsConfigCertSecret res."secret";
    }
    // {
    };
  RemoteReadOauth2TlsConfigCertSecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkRemoteReadOauth2TlsConfigCertSecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  RemoteReadOauth2TlsConfigKeySecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkRemoteReadOauth2TlsConfigKeySecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  RemoteReadOauth2TlsConfigModule = types.submodule {
    options = {
      "ca" = mkOption {
        description = "Certificate authority used when verifying server certificates.";
        type = (types.nullOr RemoteReadOauth2TlsConfigCaModule);
        default = null;
      };
      "cert" = mkOption {
        description = "Client certificate to present when doing client-authentication.";
        type = (types.nullOr RemoteReadOauth2TlsConfigCertModule);
        default = null;
      };
      "insecureSkipVerify" = mkOption {
        description = "Disable target certificate validation.";
      ...
      "keySecret" = mkOption {
        description = "Secret containing the client key file for the targets.";
        type = (types.nullOr RemoteReadOauth2TlsConfigKeySecretModule);
        default = null;
      };
      "maxVersion" = mkOption {
        description = "Maximum acceptable TLS version.\n\nIt requires Prometheus >= v2.41.0 or Thanos >= v0.31.0.";
  ...
  mkRemoteReadOauth2TlsConfig =
    res:
    {
    }
    // optionalAttrs (res."ca" != null) { "ca" = mkRemoteReadOauth2TlsConfigCa res."ca"; }
    // {
    }
    // optionalAttrs (res."cert" != null) { "cert" = mkRemoteReadOauth2TlsConfigCert res."cert"; }
    // {
    }
    // optionalAttrs res."insecureSkipVerify" { inherit (res) "insecureSkipVerify"; }
    // {
    ...
    // optionalAttrs (res."keySecret" != null) {
      "keySecret" = mkRemoteReadOauth2TlsConfigKeySecret res."keySecret";
    }
    // {
    }
    // optionalAttrs (res."maxVersion" != null) { inherit (res) "maxVersion"; }
  ...
  RemoteReadTlsConfigCaConfigMapModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key to select.";
        type = types.str;
  ...
  mkRemoteReadTlsConfigCaConfigMap =
    res:
    {
      inherit (res) "key";
    }
  ...
  RemoteReadTlsConfigCaModule = types.submodule {
    options = {
      "configMap" = mkOption {
        description = "ConfigMap containing data to use for the targets.";
        type = (types.nullOr RemoteReadTlsConfigCaConfigMapModule);
        default = null;
      };
      "secret" = mkOption {
        description = "Secret containing data to use for the targets.";
        type = (types.nullOr RemoteReadTlsConfigCaSecretModule);
        default = null;
      };
    };
  };
  mkRemoteReadTlsConfigCa =
    res:
    {
    }
    // optionalAttrs (res."configMap" != null) {
      "configMap" = mkRemoteReadTlsConfigCaConfigMap res."configMap";
    }
    // {
    }
    // optionalAttrs (res."secret" != null) { "secret" = mkRemoteReadTlsConfigCaSecret res."secret"; }
    // {
    };
  RemoteReadTlsConfigCaSecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  RemoteReadTlsConfigCertConfigMapModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key to select.";
        type = types.str;
  ...
  mkRemoteReadTlsConfigCertConfigMap =
    res:
    {
      inherit (res) "key";
    }
  ...
  RemoteReadTlsConfigCertModule = types.submodule {
    options = {
      "configMap" = mkOption {
        description = "ConfigMap containing data to use for the targets.";
        type = (types.nullOr RemoteReadTlsConfigCertConfigMapModule);
        default = null;
      };
      "secret" = mkOption {
        description = "Secret containing data to use for the targets.";
        type = (types.nullOr RemoteReadTlsConfigCertSecretModule);
        default = null;
      };
    };
  };
  mkRemoteReadTlsConfigCert =
    res:
    {
    }
    // optionalAttrs (res."configMap" != null) {
      "configMap" = mkRemoteReadTlsConfigCertConfigMap res."configMap";
    }
    // {
    }
    // optionalAttrs (res."secret" != null) { "secret" = mkRemoteReadTlsConfigCertSecret res."secret"; }
    // {
    };
  RemoteReadTlsConfigCertSecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkRemoteReadTlsConfigCertSecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  RemoteReadTlsConfigKeySecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkRemoteReadTlsConfigKeySecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  RemoteReadTlsConfigModule = types.submodule {
    options = {
      "ca" = mkOption {
        description = "Certificate authority used when verifying server certificates.";
        type = (types.nullOr RemoteReadTlsConfigCaModule);
        default = null;
      };
      "caFile" = mkOption {
        description = "Path to the CA cert in the Prometheus container to use for the targets.";
      ...
      "cert" = mkOption {
        description = "Client certificate to present when doing client-authentication.";
        type = (types.nullOr RemoteReadTlsConfigCertModule);
        default = null;
      };
      "certFile" = mkOption {
        description = "Path to the client cert file in the Prometheus container for the targets.";
      ...
      "keySecret" = mkOption {
        description = "Secret containing the client key file for the targets.";
        type = (types.nullOr RemoteReadTlsConfigKeySecretModule);
        default = null;
      };
      "maxVersion" = mkOption {
        description = "Maximum acceptable TLS version.\n\nIt requires Prometheus >= v2.41.0 or Thanos >= v0.31.0.";
  ...
  mkRemoteReadTlsConfig =
    res:
    {
    }
    // optionalAttrs (res."ca" != null) { "ca" = mkRemoteReadTlsConfigCa res."ca"; }
    // {
    }
    // optionalAttrs (res."caFile" != null) { inherit (res) "caFile"; }
    // {
    }
    // optionalAttrs (res."cert" != null) { "cert" = mkRemoteReadTlsConfigCert res."cert"; }
    // {
    }
    // optionalAttrs (res."certFile" != null) { inherit (res) "certFile"; }
    // {
    ...
    // optionalAttrs (res."keySecret" != null) {
      "keySecret" = mkRemoteReadTlsConfigKeySecret res."keySecret";
    }
    // {
    }
    // optionalAttrs (res."maxVersion" != null) { inherit (res) "maxVersion"; }
  ...
  RuleNamespaceSelectorMatchExpressionModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "key is the label key that the selector applies to.";
        type = types.str;
  ...
  mkRuleNamespaceSelectorMatchExpression =
    res:
    {
      inherit (res) "key";
      inherit (res) "operator";
  ...
  RuleNamespaceSelectorModule = types.submodule {
    options = {
      "matchExpressions" = mkOption {
        description = "matchExpressions is a list of label selector requirements. The requirements are ANDed.";
        type = (types.listOf RuleNamespaceSelectorMatchExpressionModule);
        default = [ ];
      };
      "matchLabels" = mkOption {
        description = "matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels\nmap is equivalent to an element of matchExpressions, whose key field is \"key\", the\noperator is \"In\", and the values array contains only \"value\". The requirements are ANDed.";
  ...
  mkRuleNamespaceSelector =
    res:
    {
    }
    // optionalAttrs (res."matchExpressions" != [ ]) {
      "matchExpressions" = map mkRuleNamespaceSelectorMatchExpression res."matchExpressions";
    }
    // {
    }
    // optionalAttrs (res."matchLabels" != { }) { inherit (res) "matchLabels"; }
  ...
  RuleSelectorMatchExpressionModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "key is the label key that the selector applies to.";
        type = types.str;
  ...
  RuleSelectorModule = types.submodule {
    options = {
      "matchExpressions" = mkOption {
        description = "matchExpressions is a list of label selector requirements. The requirements are ANDed.";
        type = (types.listOf RuleSelectorMatchExpressionModule);
        default = [ ];
      };
      "matchLabels" = mkOption {
        description = "matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels\nmap is equivalent to an element of matchExpressions, whose key field is \"key\", the\noperator is \"In\", and the values array contains only \"value\". The requirements are ANDed.";
  ...
  mkRuleSelector =
    ...
    // optionalAttrs (res."matchExpressions" != [ ]) {
      "matchExpressions" = map mkRuleSelectorMatchExpression res."matchExpressions";
    }
    // {
    }
    // optionalAttrs (res."matchLabels" != { }) { inherit (res) "matchLabels"; }
  ...
  RulesAlertModule = types.submodule {
    options = {
  ...
  mkRulesAlert =
    ...
    // optionalAttrs (res."forGracePeriod" != null) { inherit (res) "forGracePeriod"; }
    // {
    }
    // optionalAttrs (res."forOutageTolerance" != null) { inherit (res) "forOutageTolerance"; }
    // {
    }
    // optionalAttrs (res."resendDelay" != null) { inherit (res) "resendDelay"; }
    // {
    };
  RulesModule = types.submodule {
    options = {
      "alert" = mkOption {
        ...
        type = (types.nullOr RulesAlertModule);
        default = null;
      };
    };
  };
  mkRules =
    ...
    // optionalAttrs (res."alert" != null) { "alert" = mkRulesAlert res."alert"; }
    // {
    };
  ...
  ShardRetentionPolicyModule = types.submodule {
    options = {
      "retain" = mkOption {
        ...
        type = (types.nullOr ShardRetentionPolicyRetainModule);
        default = null;
      };
      "whenScaled" = mkOption {
  ...
  mkShardRetentionPolicy =
    res:
    {
    }
    // optionalAttrs (res."retain" != null) { "retain" = mkShardRetentionPolicyRetain res."retain"; }
    // {
    }
    // optionalAttrs (res."whenScaled" != null) { inherit (res) "whenScaled"; }
    // {
    };
  ShardRetentionPolicyRetainModule = types.submodule {
    options = {
  ...
  mkShardRetentionPolicyRetain = res: {
    inherit (res) "retentionPeriod";
  };
  ...
  ThanosAdditionalArgModule = types.submodule {
    options = {
      "name" = mkOption {
        description = "Name of the argument, e.g. \"scrape.discovery-reload-interval\".";
        type = types.str;
  ...
  ThanosGrpcServerTlsConfigCaConfigMapModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key to select.";
        type = types.str;
  ...
  mkThanosGrpcServerTlsConfigCaConfigMap =
    res:
    {
      inherit (res) "key";
    }
  ...
  ThanosGrpcServerTlsConfigCaModule = types.submodule {
    options = {
      "configMap" = mkOption {
        description = "ConfigMap containing data to use for the targets.";
        type = (types.nullOr ThanosGrpcServerTlsConfigCaConfigMapModule);
        default = null;
      };
      "secret" = mkOption {
        description = "Secret containing data to use for the targets.";
        type = (types.nullOr ThanosGrpcServerTlsConfigCaSecretModule);
        default = null;
      };
    };
  };
  mkThanosGrpcServerTlsConfigCa =
    res:
    {
    }
    // optionalAttrs (res."configMap" != null) {
      "configMap" = mkThanosGrpcServerTlsConfigCaConfigMap res."configMap";
    }
    // {
    }
    // optionalAttrs (res."secret" != null) {
      "secret" = mkThanosGrpcServerTlsConfigCaSecret res."secret";
    }
    // {
    };
  ThanosGrpcServerTlsConfigCaSecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkThanosGrpcServerTlsConfigCaSecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  ThanosGrpcServerTlsConfigCertConfigMapModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key to select.";
        type = types.str;
  ...
  mkThanosGrpcServerTlsConfigCertConfigMap =
    res:
    {
      inherit (res) "key";
    }
  ...
  ThanosGrpcServerTlsConfigCertModule = types.submodule {
    options = {
      "configMap" = mkOption {
        description = "ConfigMap containing data to use for the targets.";
        type = (types.nullOr ThanosGrpcServerTlsConfigCertConfigMapModule);
        default = null;
      };
      "secret" = mkOption {
        description = "Secret containing data to use for the targets.";
        type = (types.nullOr ThanosGrpcServerTlsConfigCertSecretModule);
        default = null;
      };
    };
  };
  mkThanosGrpcServerTlsConfigCert =
    res:
    {
    }
    // optionalAttrs (res."configMap" != null) {
      "configMap" = mkThanosGrpcServerTlsConfigCertConfigMap res."configMap";
    }
    // {
    }
    // optionalAttrs (res."secret" != null) {
      "secret" = mkThanosGrpcServerTlsConfigCertSecret res."secret";
    }
    // {
    };
  ThanosGrpcServerTlsConfigCertSecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkThanosGrpcServerTlsConfigCertSecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  ThanosGrpcServerTlsConfigKeySecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkThanosGrpcServerTlsConfigKeySecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  ThanosGrpcServerTlsConfigModule = types.submodule {
    options = {
      "ca" = mkOption {
        description = "Certificate authority used when verifying server certificates.";
        type = (types.nullOr ThanosGrpcServerTlsConfigCaModule);
        default = null;
      };
      "caFile" = mkOption {
        description = "Path to the CA cert in the Prometheus container to use for the targets.";
      ...
      "cert" = mkOption {
        description = "Client certificate to present when doing client-authentication.";
        type = (types.nullOr ThanosGrpcServerTlsConfigCertModule);
        default = null;
      };
      "certFile" = mkOption {
        description = "Path to the client cert file in the Prometheus container for the targets.";
      ...
      "keySecret" = mkOption {
        description = "Secret containing the client key file for the targets.";
        type = (types.nullOr ThanosGrpcServerTlsConfigKeySecretModule);
        default = null;
      };
      "maxVersion" = mkOption {
        description = "Maximum acceptable TLS version.\n\nIt requires Prometheus >= v2.41.0 or Thanos >= v0.31.0.";
  ...
  mkThanosGrpcServerTlsConfig =
    res:
    {
    }
    // optionalAttrs (res."ca" != null) { "ca" = mkThanosGrpcServerTlsConfigCa res."ca"; }
    // {
    }
    // optionalAttrs (res."caFile" != null) { inherit (res) "caFile"; }
    // {
    }
    // optionalAttrs (res."cert" != null) { "cert" = mkThanosGrpcServerTlsConfigCert res."cert"; }
    // {
    }
    // optionalAttrs (res."certFile" != null) { inherit (res) "certFile"; }
    // {
    ...
    // optionalAttrs (res."keySecret" != null) {
      "keySecret" = mkThanosGrpcServerTlsConfigKeySecret res."keySecret";
    }
    // {
    }
    // optionalAttrs (res."maxVersion" != null) { inherit (res) "maxVersion"; }
  ...
  ThanosModule = types.submodule {
    options = {
      "additionalArgs" = mkOption {
        ...
        type = (types.listOf ThanosAdditionalArgModule);
        default = [ ];
      };
      "baseImage" = mkOption {
      ...
      "grpcServerTlsConfig" = mkOption {
        ...
        type = (types.nullOr ThanosGrpcServerTlsConfigModule);
        default = null;
      };
      ...
      "objectStorageConfig" = mkOption {
        ...
        type = (types.nullOr ThanosObjectStorageConfigModule);
        default = null;
      };
      ...
      "resources" = mkOption {
        ...
        type = (types.nullOr ThanosResourcesModule);
        default = null;
      };
      "sha" = mkOption {
      ...
      "tracingConfig" = mkOption {
        ...
        type = (types.nullOr ThanosTracingConfigModule);
        default = null;
      };
      ...
      "volumeMounts" = mkOption {
        ...
        type = (types.listOf ThanosVolumeMountModule);
        default = [ ];
      };
    };
  };
  mkThanos =
    ...
    // optionalAttrs (res."additionalArgs" != [ ]) {
      "additionalArgs" = map mkThanosAdditionalArg res."additionalArgs";
    }
    // {
    }
    ...
    // optionalAttrs (res."blockSize" != null) { inherit (res) "blockSize"; }
    // {
    }
    // optionalAttrs (res."getConfigInterval" != null) { inherit (res) "getConfigInterval"; }
    // {
    }
    // optionalAttrs (res."getConfigTimeout" != null) { inherit (res) "getConfigTimeout"; }
    // {
    }
    // optionalAttrs res."grpcListenLocal" { inherit (res) "grpcListenLocal"; }
    // {
    }
    // optionalAttrs (res."grpcServerTlsConfig" != null) {
      "grpcServerTlsConfig" = mkThanosGrpcServerTlsConfig res."grpcServerTlsConfig";
    }
    // {
    }
    // optionalAttrs res."httpListenLocal" { inherit (res) "httpListenLocal"; }
    // {
    }
    // optionalAttrs (res."image" != null) { inherit (res) "image"; }
    // {
    ...
    // optionalAttrs (res."minTime" != null) { inherit (res) "minTime"; }
    // {
    }
    // optionalAttrs (res."objectStorageConfig" != null) {
      "objectStorageConfig" = mkThanosObjectStorageConfig res."objectStorageConfig";
    }
    // {
    }
    // optionalAttrs (res."objectStorageConfigFile" != null) {
      inherit (res) "objectStorageConfigFile";
    }
    // {
    }
    // optionalAttrs (res."readyTimeout" != null) { inherit (res) "readyTimeout"; }
    // {
    }
    // optionalAttrs (res."resources" != null) { "resources" = mkThanosResources res."resources"; }
    // {
    }
    ...
    // optionalAttrs (res."tracingConfig" != null) {
      "tracingConfig" = mkThanosTracingConfig res."tracingConfig";
    }
    // {
    }
    // optionalAttrs (res."tracingConfigFile" != null) { inherit (res) "tracingConfigFile"; }
    // {
    }
    ...
    // optionalAttrs (res."volumeMounts" != [ ]) {
      "volumeMounts" = map mkThanosVolumeMount res."volumeMounts";
    }
    // {
    };
  ThanosObjectStorageConfigModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  ThanosResourcesClaimModule = types.submodule {
    options = {
      "name" = mkOption {
        description = "Name must match the name of one entry in pod.spec.resourceClaims of\nthe Pod where this field is used. It makes that resource available\ninside a container.";
        type = types.str;
  ...
  ThanosResourcesModule = types.submodule {
    options = {
      "claims" = mkOption {
        description = "Claims lists the names of resources, defined in spec.resourceClaims,\nthat are used by this container.\n\nThis is an alpha field and requires enabling the\nDynamicResourceAllocation feature gate.\n\nThis field is immutable. It can only be set for containers.";
        type = (types.listOf ThanosResourcesClaimModule);
        default = [ ];
      };
      "limits" = mkOption {
        description = "Limits describes the maximum amount of compute resources allowed.\nMore info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/";
  ...
  mkThanosResources =
    ...
    // optionalAttrs (res."claims" != [ ]) { "claims" = map mkThanosResourcesClaim res."claims"; }
    // {
    }
    // optionalAttrs (res."limits" != { }) { inherit (res) "limits"; }
    // {
  ...
  ThanosTracingConfigModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  ThanosVolumeMountModule = types.submodule {
    options = {
      "mountPath" = mkOption {
        description = "Path within the container at which the volume should be mounted.  Must\nnot contain ':'.";
        type = types.str;
  ...
  PrometheusesModule = types.submodule (
    { name, ... }:
    {
      options = {
        "namespace" = mkOption {
          type = types.str;
          description = "Namespace for this Prometheus resource.";
        };
        "additionalAlertManagerConfigs" = mkOption {
          ...
          type = (types.nullOr AdditionalAlertManagerConfigsModule);
          default = null;
        };
        "additionalAlertRelabelConfigs" = mkOption {
          ...
          type = (types.nullOr AdditionalAlertRelabelConfigsModule);
          default = null;
        };
        "additionalArgs" = mkOption {
        ...
        "alerting" = mkOption {
          ...
          type = (types.nullOr AlertingModule);
          default = null;
        };
        ...
        "exemplars" = mkOption {
          ...
          type = (types.nullOr ExemplarsModule);
          default = null;
        };
        ...
        "prometheusRulesExcludedFromEnforce" = mkOption {
          ...
          type = (types.listOf PrometheusRulesExcludedFromEnforceModule);
          default = [ ];
        };
        "query" = mkOption {
          description = "QuerySpec defines the configuration of the Promethus query service.";
          type = (types.nullOr QueryModule);
          default = null;
        };
        ...
        "remoteRead" = mkOption {
          ...
          type = (types.listOf RemoteReadModule);
          default = [ ];
        };
        ...
        "ruleNamespaceSelector" = mkOption {
          ...
          type = (types.nullOr RuleNamespaceSelectorModule);
          default = null;
        };
        ...
        "shardRetentionPolicy" = mkOption {
          ...
          type = (types.nullOr ShardRetentionPolicyModule);
          default = null;
        };
        "shards" = mkOption {
        ...
        "thanos" = mkOption {
          ...
          type = (types.nullOr ThanosModule);
          default = null;
        };
  ...
  mkPrometheus = name: res: {
    ...
    // optionalAttrs (res."additionalAlertManagerConfigs" != null) {
      "additionalAlertManagerConfigs" =
        mkAdditionalAlertManagerConfigs
          res."additionalAlertManagerConfigs";
    }
    // {
    }
    // optionalAttrs (res."additionalAlertRelabelConfigs" != null) {
      "additionalAlertRelabelConfigs" =
        mkAdditionalAlertRelabelConfigs
          res."additionalAlertRelabelConfigs";
    }
    // {
    }
    // optionalAttrs (res."additionalArgs" != [ ]) {
    ...
    // optionalAttrs (res."alerting" != null) { "alerting" = mkAlerting res."alerting"; }
    // {
    }
    // optionalAttrs res."allowOverlappingBlocks" { inherit (res) "allowOverlappingBlocks"; }
    // {
    }
    ...
    // optionalAttrs res."disableCompaction" { inherit (res) "disableCompaction"; }
    // {
    }
    ...
    // optionalAttrs res."enableAdminAPI" { inherit (res) "enableAdminAPI"; }
    // {
    }
    ...
    // optionalAttrs (res."evaluationInterval" != null) { inherit (res) "evaluationInterval"; }
    // {
    }
    ...
    // optionalAttrs (res."exemplars" != null) { "exemplars" = mkExemplars res."exemplars"; }
    // {
    }
    ...
    // optionalAttrs (res."prometheusRulesExcludedFromEnforce" != [ ]) {
      "prometheusRulesExcludedFromEnforce" =
        map mkPrometheusRulesExcludedFromEnforce
          res."prometheusRulesExcludedFromEnforce";
    }
    // {
    }
    // optionalAttrs (res."query" != null) { "query" = mkQuery res."query"; }
    // {
    }
    // optionalAttrs (res."queryLogFile" != null) { inherit (res) "queryLogFile"; }
    // {
    }
    // optionalAttrs (res."reloadStrategy" != null) { inherit (res) "reloadStrategy"; }
    // {
    }
    // optionalAttrs (res."remoteRead" != [ ]) { "remoteRead" = map mkRemoteRead res."remoteRead"; }
    // {
    }
    ...
    // optionalAttrs (res."retentionSize" != null) { inherit (res) "retentionSize"; }
    // {
    }
    // optionalAttrs (res."routePrefix" != null) { inherit (res) "routePrefix"; }
    // {
    }
    // optionalAttrs (res."ruleNamespaceSelector" != null) {
      "ruleNamespaceSelector" = mkRuleNamespaceSelector res."ruleNamespaceSelector";
    }
    // {
    }
    // optionalAttrs (res."ruleQueryOffset" != null) { inherit (res) "ruleQueryOffset"; }
    // {
    }
    // optionalAttrs (res."ruleSelector" != null) {
      "ruleSelector" = mkRuleSelector res."ruleSelector";
    }
    // {
    }
    // optionalAttrs (res."rules" != null) { "rules" = mkRules res."rules"; }
    // {
    }
    ...
    // optionalAttrs (res."shardRetentionPolicy" != null) {
      "shardRetentionPolicy" = mkShardRetentionPolicy res."shardRetentionPolicy";
    }
    // {
    }
    ...
    // optionalAttrs (res."thanos" != null) { "thanos" = mkThanos res."thanos"; }
    // {
    }
  ...
  allResources = (mapAttrsToList mkPrometheus cfg."prometheuses");
in
{
  options.openkrill.apps."kube-prometheus" = {
    "prometheuses" = mkOption {
      type = types.attrsOf PrometheusesModule;
      default = { };
      description = "Prometheus CRD instances.";
    };
  };
