...
let
  ...
  AlertRelabelConfigsModule = types.submodule {
    options = {
      "key" = mkOption {
  ...
  AlertmanagersConfigModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  GrpcServerTlsConfigCaConfigMapModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key to select.";
        type = types.str;
  ...
  mkGrpcServerTlsConfigCaConfigMap =
    res:
    {
      inherit (res) "key";
    }
  ...
  GrpcServerTlsConfigCaModule = types.submodule {
    options = {
      "configMap" = mkOption {
        description = "ConfigMap containing data to use for the targets.";
        type = (types.nullOr GrpcServerTlsConfigCaConfigMapModule);
        default = null;
      };
      "secret" = mkOption {
        description = "Secret containing data to use for the targets.";
        type = (types.nullOr GrpcServerTlsConfigCaSecretModule);
        default = null;
      };
    };
  };
  mkGrpcServerTlsConfigCa =
    res:
    {
    }
    // optionalAttrs (res."configMap" != null) {
      "configMap" = mkGrpcServerTlsConfigCaConfigMap res."configMap";
    }
    // {
    }
    // optionalAttrs (res."secret" != null) { "secret" = mkGrpcServerTlsConfigCaSecret res."secret"; }
    // {
    };
  GrpcServerTlsConfigCaSecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  GrpcServerTlsConfigCertConfigMapModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key to select.";
        type = types.str;
  ...
  mkGrpcServerTlsConfigCertConfigMap =
    res:
    {
      inherit (res) "key";
    }
  ...
  GrpcServerTlsConfigCertModule = types.submodule {
    options = {
      "configMap" = mkOption {
        description = "ConfigMap containing data to use for the targets.";
        type = (types.nullOr GrpcServerTlsConfigCertConfigMapModule);
        default = null;
      };
      "secret" = mkOption {
        description = "Secret containing data to use for the targets.";
        type = (types.nullOr GrpcServerTlsConfigCertSecretModule);
        default = null;
      };
    };
  };
  mkGrpcServerTlsConfigCert =
    res:
    {
    }
    // optionalAttrs (res."configMap" != null) {
      "configMap" = mkGrpcServerTlsConfigCertConfigMap res."configMap";
    }
    // {
    }
    // optionalAttrs (res."secret" != null) { "secret" = mkGrpcServerTlsConfigCertSecret res."secret"; }
    // {
    };
  GrpcServerTlsConfigCertSecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkGrpcServerTlsConfigCertSecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  GrpcServerTlsConfigKeySecretModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  mkGrpcServerTlsConfigKeySecret =
    res:
    {
      inherit (res) "key";
    }
  ...
  GrpcServerTlsConfigModule = types.submodule {
    options = {
      "ca" = mkOption {
        description = "Certificate authority used when verifying server certificates.";
        type = (types.nullOr GrpcServerTlsConfigCaModule);
        default = null;
      };
      "caFile" = mkOption {
      ...
      "cert" = mkOption {
        ...
        type = (types.nullOr GrpcServerTlsConfigCertModule);
        default = null;
      };
      "certFile" = mkOption {
      ...
      "keySecret" = mkOption {
        ...
        type = (types.nullOr GrpcServerTlsConfigKeySecretModule);
        default = null;
      };
      "maxVersion" = mkOption {
  ...
  mkGrpcServerTlsConfig =
    res:
    {
    }
    // optionalAttrs (res."ca" != null) { "ca" = mkGrpcServerTlsConfigCa res."ca"; }
    // {
    }
    // optionalAttrs (res."caFile" != null) { inherit (res) "caFile"; }
    // {
    }
    // optionalAttrs (res."cert" != null) { "cert" = mkGrpcServerTlsConfigCert res."cert"; }
    // {
    }
    ...
    // optionalAttrs (res."keySecret" != null) {
      "keySecret" = mkGrpcServerTlsConfigKeySecret res."keySecret";
    }
    // {
    }
  ...
  ObjectStorageConfigModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  QueryConfigModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "The key of the secret to select from.  Must be a valid secret key.";
        type = types.str;
  ...
  ThanosrulersModule = types.submodule (
    { name, ... }:
    {
      options = {
        "namespace" = mkOption {
          type = types.str;
          description = "Namespace for this ThanosRuler resource.";
        };
        ...
        "alertRelabelConfigs" = mkOption {
          ...
          type = (types.nullOr AlertRelabelConfigsModule);
          default = null;
        };
        "alertmanagersConfig" = mkOption {
          ...
          type = (types.nullOr AlertmanagersConfigModule);
          default = null;
        };
        ...
        "grpcServerTlsConfig" = mkOption {
          ...
          type = (types.nullOr GrpcServerTlsConfigModule);
          default = null;
        };
        ...
        "objectStorageConfig" = mkOption {
          ...
          type = (types.nullOr ObjectStorageConfigModule);
          default = null;
        };
        ...
        "queryConfig" = mkOption {
          ...
          type = (types.nullOr QueryConfigModule);
          default = null;
        };
  ...
  mkThanosRuler = name: res: {
    ...
    // optionalAttrs (res."alertDropLabels" != [ ]) { inherit (res) "alertDropLabels"; }
    // {
    }
    // optionalAttrs (res."alertQueryUrl" != null) { inherit (res) "alertQueryUrl"; }
    // {
    }
    // optionalAttrs (res."alertRelabelConfigFile" != null) { inherit (res) "alertRelabelConfigFile"; }
    // {
    }
    // optionalAttrs (res."alertRelabelConfigs" != null) {
      "alertRelabelConfigs" = mkAlertRelabelConfigs res."alertRelabelConfigs";
    }
    // {
    }
    // optionalAttrs (res."alertmanagersConfig" != null) {
      "alertmanagersConfig" = mkAlertmanagersConfig res."alertmanagersConfig";
    }
    // {
    }
    // optionalAttrs (res."alertmanagersUrl" != [ ]) { inherit (res) "alertmanagersUrl"; }
    // {
    }
    ...
    // optionalAttrs (res."externalPrefix" != null) { inherit (res) "externalPrefix"; }
    // {
    }
    // optionalAttrs (res."grpcServerTlsConfig" != null) {
      "grpcServerTlsConfig" = mkGrpcServerTlsConfig res."grpcServerTlsConfig";
    }
    // {
    }
    ...
    // optionalAttrs (res."objectStorageConfig" != null) {
      "objectStorageConfig" = mkObjectStorageConfig res."objectStorageConfig";
    }
    // {
    }
    ...
    // optionalAttrs (res."queryConfig" != null) { "queryConfig" = mkQueryConfig res."queryConfig"; }
    // {
    }
    // optionalAttrs (res."queryEndpoints" != [ ]) { inherit (res) "queryEndpoints"; }
    // {
    }
    ...
    // optionalAttrs (res."ruleConcurrentEval" != null) { inherit (res) "ruleConcurrentEval"; }
    // {
    }
    // optionalAttrs (res."ruleGracePeriod" != null) { inherit (res) "ruleGracePeriod"; }
    // {
    }
    ...
    // optionalAttrs (res."ruleOutageTolerance" != null) { inherit (res) "ruleOutageTolerance"; }
    // {
    }
  ...
  allResources = (mapAttrsToList mkThanosRuler cfg."thanosrulers");
in
{
  options.openkrill.apps."kube-prometheus" = {
    "thanosrulers" = mkOption {
      type = types.attrsOf ThanosrulersModule;
      default = { };
      description = "ThanosRuler CRD instances.";
    };
  };
