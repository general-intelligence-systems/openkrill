...
let
  ...
  ClickhouseinstallationsModule = types.submodule (
    { name, ... }:
    {
      options = {
        "namespace" = mkOption {
          type = types.str;
          description = "Namespace for this ClickHouseInstallation resource.";
        };
  ...
  mkClickHouseInstallation = name: res: {
  ...
  allResources = (mapAttrsToList mkClickHouseInstallation cfg."clickhouseinstallations");
in
{
  options.openkrill.apps."clickhouse-operator" = {
    "clickhouseinstallations" = mkOption {
      type = types.attrsOf ClickhouseinstallationsModule;
      default = { };
      description = "ClickHouseInstallation CRD instances.";
    };
  };
