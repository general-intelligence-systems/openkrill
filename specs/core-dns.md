...
**DaemonSet** (`apps/stable/core-dns/resources.nix`):
...
**Service** (`apps/stable/core-dns/resources.nix`):
...
```nix
# apps/stable/core-dns/resources.nix (simplified)
...
```nix
# apps/stable/core-dns/default.nix
