...
let
  ...
  SourceHydratorDrySourceDirectoryJsonnetExtVarModule = types.submodule {
    options = {
      "code" = mkOption {
        type = types.bool;
        default = false;
  ...
  mkSourceHydratorDrySourceDirectoryJsonnetExtVar =
    res:
    {
    }
    // optionalAttrs res."code" { inherit (res) "code"; }
  ...
  SourceHydratorDrySourceDirectoryJsonnetModule = types.submodule {
    options = {
      "extVars" = mkOption {
        description = "ExtVars is a list of Jsonnet External Variables";
        type = (types.listOf SourceHydratorDrySourceDirectoryJsonnetExtVarModule);
        default = [ ];
      };
      "libs" = mkOption {
        description = "Additional library search dirs";
      ...
      "tlas" = mkOption {
        description = "TLAS is a list of Jsonnet Top-level Arguments";
        type = (types.listOf SourceHydratorDrySourceDirectoryJsonnetTlaModule);
        default = [ ];
      };
    };
  };
  mkSourceHydratorDrySourceDirectoryJsonnet =
    res:
    {
    }
    // optionalAttrs (res."extVars" != [ ]) {
      "extVars" = map mkSourceHydratorDrySourceDirectoryJsonnetExtVar res."extVars";
    }
    // {
    }
    // optionalAttrs (res."libs" != [ ]) { inherit (res) "libs"; }
    ...
    // optionalAttrs (res."tlas" != [ ]) {
      "tlas" = map mkSourceHydratorDrySourceDirectoryJsonnetTla res."tlas";
    }
    // {
    };
  SourceHydratorDrySourceDirectoryJsonnetTlaModule = types.submodule {
    options = {
      "code" = mkOption {
        type = types.bool;
        default = false;
  ...
  mkSourceHydratorDrySourceDirectoryJsonnetTla =
    res:
    {
    }
    // optionalAttrs res."code" { inherit (res) "code"; }
  ...
  SourceHydratorDrySourceDirectoryModule = types.submodule {
    options = {
      "exclude" = mkOption {
        description = "Exclude contains a glob pattern to match paths against that should be explicitly excluded from being used during manifest generation";
        type = (types.nullOr types.str);
      ...
      "jsonnet" = mkOption {
        description = "Jsonnet holds options specific to Jsonnet";
        type = (types.nullOr SourceHydratorDrySourceDirectoryJsonnetModule);
        default = null;
      };
      "recurse" = mkOption {
        description = "Recurse specifies whether to scan a directory recursively for manifests";
  ...
  mkSourceHydratorDrySourceDirectory =
    res:
    {
    }
    // optionalAttrs (res."exclude" != null) { inherit (res) "exclude"; }
    ...
    // optionalAttrs (res."jsonnet" != null) {
      "jsonnet" = mkSourceHydratorDrySourceDirectoryJsonnet res."jsonnet";
    }
    // {
    }
    // optionalAttrs res."recurse" { inherit (res) "recurse"; }
  ...
  SourceHydratorDrySourceHelmFileParameterModule = types.submodule {
    options = {
      "name" = mkOption {
        description = "Name is the name of the Helm parameter";
        type = (types.nullOr types.str);
  ...
  mkSourceHydratorDrySourceHelmFileParameter =
    res:
    {
    }
    // optionalAttrs (res."name" != null) { inherit (res) "name"; }
  ...
  SourceHydratorDrySourceHelmModule = types.submodule {
    options = {
      "apiVersions" = mkOption {
        description = "APIVersions specifies the Kubernetes resource API versions to pass to Helm when templating manifests. By default,\nArgo CD uses the API versions of the target cluster. The format is [group/]version/kind.";
        type = (types.listOf types.str);
      ...
      "fileParameters" = mkOption {
        description = "FileParameters are file parameters to the helm template";
        type = (types.listOf SourceHydratorDrySourceHelmFileParameterModule);
        default = [ ];
      };
      "ignoreMissingValueFiles" = mkOption {
        description = "IgnoreMissingValueFiles prevents helm template from failing when valueFiles do not exist locally by not appending them to helm template --values";
      ...
      "parameters" = mkOption {
        description = "Parameters is a list of Helm parameters which are passed to the helm template command upon manifest generation";
        type = (types.listOf SourceHydratorDrySourceHelmParameterModule);
        default = [ ];
      };
      "passCredentials" = mkOption {
        description = "PassCredentials pass credentials to all domains (Helm's --pass-credentials)";
  ...
  mkSourceHydratorDrySourceHelm =
    ...
    // optionalAttrs (res."fileParameters" != [ ]) {
      "fileParameters" = map mkSourceHydratorDrySourceHelmFileParameter res."fileParameters";
    }
    // {
    }
    // optionalAttrs res."ignoreMissingValueFiles" { inherit (res) "ignoreMissingValueFiles"; }
    ...
    // optionalAttrs (res."parameters" != [ ]) {
      "parameters" = map mkSourceHydratorDrySourceHelmParameter res."parameters";
    }
    // {
    }
    // optionalAttrs res."passCredentials" { inherit (res) "passCredentials"; }
  ...
  SourceHydratorDrySourceHelmParameterModule = types.submodule {
    options = {
      "forceString" = mkOption {
        description = "ForceString determines whether to tell Helm to interpret booleans and numbers as strings";
        type = types.bool;
  ...
  mkSourceHydratorDrySourceHelmParameter =
    res:
    {
    }
    // optionalAttrs res."forceString" { inherit (res) "forceString"; }
  ...
  SourceHydratorDrySourceKustomizeModule = types.submodule {
    options = {
      "apiVersions" = mkOption {
        description = "APIVersions specifies the Kubernetes resource API versions to pass to Helm when templating manifests. By default,\nArgo CD uses the API versions of the target cluster. The format is [group/]version/kind.";
        type = (types.listOf types.str);
      ...
      "patches" = mkOption {
        ...
        type = (types.listOf SourceHydratorDrySourceKustomizePatcheModule);
        default = [ ];
      };
      "replicas" = mkOption {
        description = "Replicas is a list of Kustomize Replicas override specifications";
        type = (types.listOf SourceHydratorDrySourceKustomizeReplicaModule);
        default = [ ];
      };
      "version" = mkOption {
  ...
  mkSourceHydratorDrySourceKustomize =
    res:
    {
    }
    // optionalAttrs (res."apiVersions" != [ ]) { inherit (res) "apiVersions"; }
    ...
    // optionalAttrs (res."patches" != [ ]) {
      "patches" = map mkSourceHydratorDrySourceKustomizePatche res."patches";
    }
    // {
    }
    // optionalAttrs (res."replicas" != [ ]) {
      "replicas" = map mkSourceHydratorDrySourceKustomizeReplica res."replicas";
    }
    // {
    }
    // optionalAttrs (res."version" != null) { inherit (res) "version"; }
  ...
  SourceHydratorDrySourceKustomizePatcheModule = types.submodule {
    options = {
      "options" = mkOption {
      ...
      "target" = mkOption {
        type = (types.nullOr SourceHydratorDrySourceKustomizePatcheTargetModule);
        default = null;
      };
    };
  };
  mkSourceHydratorDrySourceKustomizePatche =
    res:
    {
    }
    ...
    // optionalAttrs (res."target" != null) {
      "target" = mkSourceHydratorDrySourceKustomizePatcheTarget res."target";
    }
    // {
    };
  SourceHydratorDrySourceKustomizePatcheTargetModule = types.submodule {
    options = {
  ...
  mkSourceHydratorDrySourceKustomizePatcheTarget =
    res:
    {
    }
  ...
  SourceHydratorDrySourceKustomizeReplicaModule = types.submodule {
    options = {
      "count" = mkOption {
  ...
  mkSourceHydratorDrySourceKustomizeReplica = res: {
    inherit (res) "count";
    inherit (res) "name";
  };
  SourceHydratorDrySourceModule = types.submodule {
    options = {
      "directory" = mkOption {
        ...
        type = (types.nullOr SourceHydratorDrySourceDirectoryModule);
        default = null;
      };
      "helm" = mkOption {
        description = "Helm specifies helm specific options";
        type = (types.nullOr SourceHydratorDrySourceHelmModule);
        default = null;
      };
      "kustomize" = mkOption {
        description = "Kustomize specifies kustomize specific options";
        type = (types.nullOr SourceHydratorDrySourceKustomizeModule);
        default = null;
      };
      "path" = mkOption {
      ...
      "plugin" = mkOption {
        ...
        type = (types.nullOr SourceHydratorDrySourcePluginModule);
        default = null;
      };
      "repoURL" = mkOption {
  ...
  mkSourceHydratorDrySource =
    res:
    {
    }
    // optionalAttrs (res."directory" != null) {
      "directory" = mkSourceHydratorDrySourceDirectory res."directory";
    }
    // {
    }
    // optionalAttrs (res."helm" != null) { "helm" = mkSourceHydratorDrySourceHelm res."helm"; }
    // {
    }
    // optionalAttrs (res."kustomize" != null) {
      "kustomize" = mkSourceHydratorDrySourceKustomize res."kustomize";
    }
    // {
      inherit (res) "path";
    }
    // optionalAttrs (res."plugin" != null) { "plugin" = mkSourceHydratorDrySourcePlugin res."plugin"; }
    // {
      inherit (res) "repoURL";
      inherit (res) "targetRevision";
    };
  SourceHydratorDrySourcePluginEnvModule = types.submodule {
    options = {
      "name" = mkOption {
  ...
  mkSourceHydratorDrySourcePluginEnv = res: {
    inherit (res) "name";
    inherit (res) "value";
  };
  SourceHydratorDrySourcePluginModule = types.submodule {
    options = {
      "env" = mkOption {
        description = "Env is a list of environment variable entries";
        type = (types.listOf SourceHydratorDrySourcePluginEnvModule);
        default = [ ];
      };
      "name" = mkOption {
        type = (types.nullOr types.str);
      ...
      "parameters" = mkOption {
        type = (types.listOf SourceHydratorDrySourcePluginParameterModule);
        default = [ ];
      };
    };
  };
  mkSourceHydratorDrySourcePlugin =
    res:
    {
    }
    // optionalAttrs (res."env" != [ ]) { "env" = map mkSourceHydratorDrySourcePluginEnv res."env"; }
    // {
    }
    // optionalAttrs (res."name" != null) { inherit (res) "name"; }
    // {
    ...
    // optionalAttrs (res."parameters" != [ ]) {
      "parameters" = map mkSourceHydratorDrySourcePluginParameter res."parameters";
    }
    // {
    };
  SourceHydratorDrySourcePluginParameterModule = types.submodule {
    options = {
      "array" = mkOption {
  ...
  mkSourceHydratorDrySourcePluginParameter =
    res:
    {
    }
  ...
  mkSyncPolicyRetry =
    ...
    // optionalAttrs res."refresh" { inherit (res) "refresh"; }
    // {
    };
