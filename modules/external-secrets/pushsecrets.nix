...
let
  ...
  DataMatchModule = types.submodule {
    options = {
      "remoteRef" = mkOption {
        description = "Remote Refs to push to providers.";
        type = DataMatchRemoteRefModule;
      };
      "secretKey" = mkOption {
  ...
  mkDataMatch =
    res:
    {
      "remoteRef" = mkDataMatchRemoteRef res."remoteRef";
    }
    // optionalAttrs (res."secretKey" != null) { inherit (res) "secretKey"; }
    // {
    };
  DataMatchRemoteRefModule = types.submodule {
    options = {
      "property" = mkOption {
  ...
  mkData =
    ...
    // {
      "match" = mkDataMatch res."match";
    }
    // optionalAttrs (res."metadata" != null) { inherit (res) "metadata"; }
    // {
    };
  SecretStoreRefLabelSelectorMatchExpressionModule = types.submodule {
    options = {
      "key" = mkOption {
  ...
  mkSecretStoreRefLabelSelectorMatchExpression =
    res:
    {
      inherit (res) "key";
  ...
  SecretStoreRefLabelSelectorModule = types.submodule {
    options = {
      "matchExpressions" = mkOption {
        description = "matchExpressions is a list of label selector requirements. The requirements are ANDed.";
        type = (types.listOf SecretStoreRefLabelSelectorMatchExpressionModule);
        default = [ ];
      };
  ...
  mkSecretStoreRefLabelSelector =
    res:
    {
    }
    // optionalAttrs (res."matchExpressions" != [ ]) {
      "matchExpressions" = map mkSecretStoreRefLabelSelectorMatchExpression res."matchExpressions";
    }
    // {
    }
  ...
  SecretStoreRefModule = types.submodule {
    options = {
      ...
      "labelSelector" = mkOption {
        ...
        type = (types.nullOr SecretStoreRefLabelSelectorModule);
        default = null;
      };
      "name" = mkOption {
  ...
  mkSecretStoreRef =
    ...
    // optionalAttrs (res."labelSelector" != null) {
      "labelSelector" = mkSecretStoreRefLabelSelector res."labelSelector";
    }
    // {
    }
  ...
  SelectorGeneratorRefModule = types.submodule {
    options = {
      "apiVersion" = mkOption {
  ...
  SelectorModule = types.submodule {
    options = {
      "generatorRef" = mkOption {
        ...
        type = (types.nullOr SelectorGeneratorRefModule);
        default = null;
      };
      "secret" = mkOption {
        description = "Select a Secret to Push.";
        type = (types.nullOr SelectorSecretModule);
        default = null;
      };
    };
  };
  mkSelector =
    ...
    // optionalAttrs (res."generatorRef" != null) {
      "generatorRef" = mkSelectorGeneratorRef res."generatorRef";
    }
    // {
    }
    // optionalAttrs (res."secret" != null) { "secret" = mkSelectorSecret res."secret"; }
    // {
    };
  SelectorSecretModule = types.submodule {
    options = {
      "name" = mkOption {
      ...
      "selector" = mkOption {
        ...
        type = (types.nullOr SelectorSecretSelectorModule);
        default = null;
      };
    };
  };
  mkSelectorSecret =
    ...
    // optionalAttrs (res."selector" != null) { "selector" = mkSelectorSecretSelector res."selector"; }
    // {
    };
  SelectorSecretSelectorMatchExpressionModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "key is the label key that the selector applies to.";
        type = types.str;
  ...
  mkSelectorSecretSelectorMatchExpression =
    res:
    {
      inherit (res) "key";
      inherit (res) "operator";
  ...
  SelectorSecretSelectorModule = types.submodule {
    options = {
      "matchExpressions" = mkOption {
        description = "matchExpressions is a list of label selector requirements. The requirements are ANDed.";
        type = (types.listOf SelectorSecretSelectorMatchExpressionModule);
        default = [ ];
      };
      "matchLabels" = mkOption {
        description = "matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels\nmap is equivalent to an element of matchExpressions, whose key field is \"key\", the\noperator is \"In\", and the values array contains only \"value\". The requirements are ANDed.";
  ...
  mkSelectorSecretSelector =
    res:
    {
    }
    // optionalAttrs (res."matchExpressions" != [ ]) {
      "matchExpressions" = map mkSelectorSecretSelectorMatchExpression res."matchExpressions";
    }
    // {
    }
    // optionalAttrs (res."matchLabels" != { }) { inherit (res) "matchLabels"; }
  ...
  TemplateModule = types.submodule {
    options = {
      ...
      "templateFrom" = mkOption {
        type = (types.listOf TemplateTemplateFromModule);
        default = [ ];
      };
      "type" = mkOption {
        type = (types.nullOr types.str);
  ...
  mkTemplate =
    ...
    // optionalAttrs (res."templateFrom" != [ ]) {
      "templateFrom" = map mkTemplateTemplateFrom res."templateFrom";
    }
    // {
    }
  ...
  TemplateTemplateFromConfigMapItemModule = types.submodule {
    options = {
      "key" = mkOption {
  ...
  mkTemplateTemplateFromConfigMapItem =
    res:
    {
      inherit (res) "key";
    }
  ...
  TemplateTemplateFromConfigMapModule = types.submodule {
    options = {
      "items" = mkOption {
        description = "A list of keys in the ConfigMap/Secret to use as templates for Secret data";
        type = (types.listOf TemplateTemplateFromConfigMapItemModule);
      };
      "name" = mkOption {
  ...
  mkTemplateTemplateFromConfigMap = res: {
    "items" = map mkTemplateTemplateFromConfigMapItem res."items";
    inherit (res) "name";
  };
  TemplateTemplateFromModule = types.submodule {
    options = {
      "configMap" = mkOption {
        description = "TemplateRef specifies a reference to either a ConfigMap or a Secret resource.";
        type = (types.nullOr TemplateTemplateFromConfigMapModule);
        default = null;
      };
      "literal" = mkOption {
        type = (types.nullOr types.str);
      ...
      "secret" = mkOption {
        description = "TemplateRef specifies a reference to either a ConfigMap or a Secret resource.";
        type = (types.nullOr TemplateTemplateFromSecretModule);
        default = null;
      };
      "target" = mkOption {
  ...
  mkTemplateTemplateFrom =
    res:
    {
    }
    // optionalAttrs (res."configMap" != null) {
      "configMap" = mkTemplateTemplateFromConfigMap res."configMap";
    }
    // {
    }
    ...
    // optionalAttrs (res."secret" != null) { "secret" = mkTemplateTemplateFromSecret res."secret"; }
    // {
    }
    // optionalAttrs (res."target" != null) { inherit (res) "target"; }
    // {
    };
  TemplateTemplateFromSecretItemModule = types.submodule {
    options = {
      "key" = mkOption {
        description = "A key in the ConfigMap/Secret";
        type = types.str;
  ...
  mkTemplateTemplateFromSecretItem =
    res:
    {
      inherit (res) "key";
    }
  ...
  TemplateTemplateFromSecretModule = types.submodule {
    options = {
      "items" = mkOption {
        description = "A list of keys in the ConfigMap/Secret to use as templates for Secret data";
        type = (types.listOf TemplateTemplateFromSecretItemModule);
      };
      "name" = mkOption {
        description = "The name of the ConfigMap/Secret resource";
        type = types.str;
  ...
  mkTemplateTemplateFromSecret = res: {
    "items" = map mkTemplateTemplateFromSecretItem res."items";
    inherit (res) "name";
  };
  PushsecretsModule = types.submodule (
    { name, ... }:
    {
      options = {
        "namespace" = mkOption {
          type = types.str;
          description = "Namespace for this PushSecret resource.";
        };
        "data" = mkOption {
        ...
        "secretStoreRefs" = mkOption {
          type = (types.listOf SecretStoreRefModule);
        };
        "selector" = mkOption {
  ...
  mkPushSecret = name: res: {
    ...
    // {
      "secretStoreRefs" = map mkSecretStoreRef res."secretStoreRefs";
  ...
  allResources = (mapAttrsToList mkPushSecret cfg."pushsecrets");
in
{
  options.openkrill.apps."external-secrets" = {
    "pushsecrets" = mkOption {
      type = types.attrsOf PushsecretsModule;
      default = { };
      description = "PushSecret CRD instances.";
    };
  };
