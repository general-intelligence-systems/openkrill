...
let
  ...
  SecretstoresModule = types.submodule (
    { name, ... }:
    {
      options = {
        "namespace" = mkOption {
          type = types.str;
          description = "Namespace for this SecretStore resource.";
        };
        "conditions" = mkOption {
  ...
  allResources = (mapAttrsToList mkSecretStore cfg."secretstores");
in
{
  options.openkrill.apps."external-secrets" = {
    "secretstores" = mkOption {
      type = types.attrsOf SecretstoresModule;
      default = { };
      description = "SecretStore CRD instances.";
    };
  };
